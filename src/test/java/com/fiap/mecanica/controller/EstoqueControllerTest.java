...
import com.fiap.mecanica.controller.request.CadastrarInsumoRequest;
...
class EstoqueControllerTest {
    ...
    void deveExecutarOperacoesDoEstoquePeloIdDoInsumo() {
        ...
        verify(service).atualizarInsumo(eq(1L), dtoCaptor.capture());
        assertThat(dtoCaptor.getValue().nome()).isEqualTo("Filtro");
    }
