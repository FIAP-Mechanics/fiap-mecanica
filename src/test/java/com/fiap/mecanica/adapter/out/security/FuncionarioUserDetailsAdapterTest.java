...
class FuncionarioUserDetailsAdapterTest {

    @Mock
    private FuncionarioGateway funcionarioGateway;

    @InjectMocks
    private FuncionarioUserDetailsAdapter adapter;
    ...
    void deveCarregarFuncionarioAtivoComRoleDaFuncao() {
        ...
        var userDetails = adapter.loadUserByUsername("mecanico@mecanica.com");
    ...
    void deveCarregarFuncionarioInativoComoDesabilitado() {
        ...
        var userDetails = adapter.loadUserByUsername("atendente@mecanica.com");
    ...
    void deveRejeitarFuncionarioInexistente() {
        when(funcionarioGateway.buscarPorEmail("ninguem@mecanica.com"))
                .thenReturn(Optional.empty());

        assertThatThrownBy(() -> adapter.loadUserByUsername("ninguem@mecanica.com"))
