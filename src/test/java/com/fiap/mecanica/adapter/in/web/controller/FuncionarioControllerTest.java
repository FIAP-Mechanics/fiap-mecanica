...
class FuncionarioControllerTest {
    ...
    void deveAtualizarFuncionarioERetornarDtoComSucesso() {
        ...
        when(service.atualizarFuncionario(eq(ID_EXISTENTE), any(AtualizarFuncionarioCommand.class)))
        ...
        verify(service).atualizarFuncionario(eq(ID_EXISTENTE), any(AtualizarFuncionarioCommand.class));
    }

    @Test
    void deveConverterRequestParaDtoCorretamenteAoAtualizar() {
        AtualizarFuncionarioRequest request = criarAtualizarRequestCompleto();
        ArgumentCaptor<AtualizarFuncionarioCommand> commandCaptor =
                ArgumentCaptor.forClass(AtualizarFuncionarioCommand.class);
        when(service.atualizarFuncionario(eq(ID_EXISTENTE), commandCaptor.capture()))
    ...
    void deveLancarFuncionarioNotFoundNoUpdateQuandoIdNaoExistir() {
        AtualizarFuncionarioRequest request = criarAtualizarRequestCompleto();
        when(service.atualizarFuncionario(eq(ID_INEXISTENTE), any(AtualizarFuncionarioCommand.class)))
                .thenThrow(new FuncionarioNotFound(ID_INEXISTENTE));
