...
public record AtualizarVeiculoRequest(
        @Size(max = 50) @Schema(description = "Nova marca do veículo", example = "Fiat") String marca,
        @Size(max = 50) @Schema(description = "Novo modelo do veículo", example = "Uno") String modelo,
