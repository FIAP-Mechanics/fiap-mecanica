...
public record IniciarAtendimentoRequest(
        ...
        @Schema(description = "ID do cliente", example = "1") Long cliente,
        @NotNull(message = "O ID do veículo é obrigatório")
        @Schema(description = "ID do veículo", example = "1") Long veiculo,
        ...
        @Schema(description = "Lista de serviços requeridos com ID e quantidade") List<ServicoQuantidade> servicos,
        @Schema(description = "Lista de insumos requeridos com ID e quantidade") List<InsumoQuantidade> insumos) {

    @Schema(description = "Dados de serviço com quantidade")
    public record ServicoQuantidade(
            @NotNull(message = "O ID do serviço é obrigatório")
            @Schema(description = "ID do serviço", example = "1") Long servico,
            @NotNull(message = "A quantidade é obrigatória")
            @PositiveOrZero(message = "A quantidade deve ser maior ou igual a zero")
            @Schema(description = "Quantidade do serviço", example = "2") Integer quantidade) {
    }
    ...
    public record InsumoQuantidade(
            ...
            @Schema(description = "ID do insumo", example = "1") Long insumo,
            @NotNull(message = "A quantidade é obrigatória")
            @PositiveOrZero(message = "A quantidade deve ser maior ou igual a zero")
            @Schema(description = "Quantidade do insumo", example = "2") Integer quantidade) {
    }
}
