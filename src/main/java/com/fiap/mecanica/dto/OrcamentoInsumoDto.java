...
public record OrcamentoInsumoDto(
        @Schema(description = "Identificador do insumo", example = "1")
        Long insumoId,

        @Schema(description = "Nome do insumo", example = "Óleo de motor")
        String nome,
        ...
        @Schema(description = "Valor total do insumo (preço unitário × quantidade)", example = "91.80")
