package com.fiap.mecanica.servico.architecture;
...
@AnalyzeClasses(packages = "com.fiap.mecanica.servico")
class CleanArchitectureTest {

    private static final String BASE_PACKAGE = "com.fiap.mecanica.servico";
