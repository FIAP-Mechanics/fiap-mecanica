package com.fiap.mecanica.cliente.architecture;
...
@AnalyzeClasses(packages = "com.fiap.mecanica.cliente")
class CleanArchitectureTest {

    private static final String BASE_PACKAGE = "com.fiap.mecanica.cliente";
