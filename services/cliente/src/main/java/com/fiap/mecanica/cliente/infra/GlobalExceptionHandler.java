package com.fiap.mecanica.cliente.infra;

import com.fiap.mecanica.cliente.exception.ConflitoException;
import com.fiap.mecanica.cliente.exception.EntidadeNaoEncontradaException;
import com.fiap.mecanica.cliente.exception.ValidacaoException;
import com.fiap.mecanica.cliente.infra.dto.ErroDetalhe;
import com.fiap.mecanica.cliente.infra.dto.RespostaErro;
import com.fiap.mecanica.cliente.infra.enums.CodigoErro;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<RespostaErro> handleNotFound(EntidadeNaoEncontradaException ex) {
        return ResponseEntity
                ...
                .body(new RespostaErro(
                        List.of(new ErroDetalhe(CodigoErro.ENTIDADE_NAO_ENCONTRADA.getCodigo(), ex.getMessage()))
                ));
    }
    ...
    public ResponseEntity<RespostaErro> handleConflict(ConflitoException ex) {
        return ResponseEntity
                ...
                .body(new RespostaErro(
                        List.of(new ErroDetalhe(CodigoErro.CONFLITO.getCodigo(), ex.getMessage()))
                ));
    }
    ...
    public ResponseEntity<RespostaErro> handleAuthentication(AuthenticationException ex) {
        return ResponseEntity
                ...
                .body(new RespostaErro(
                        List.of(new ErroDetalhe(CodigoErro.NAO_AUTORIZADO.getCodigo(), "Credenciais invalidas."))
                ));
    }
    ...
    public ResponseEntity<RespostaErro> handleAccessDenied(AccessDeniedException ex) {
        return ResponseEntity
                ...
                .body(new RespostaErro(
                        List.of(new ErroDetalhe(CodigoErro.ACESSO_NEGADO.getCodigo(), "Acesso negado para esta operacao."))
                ));
    }
    ...
    public ResponseEntity<RespostaErro> handleGeneric(Exception ex) {
        ...
        return ResponseEntity
                ...
                .body(new RespostaErro(
                        List.of(new ErroDetalhe(CodigoErro.ERRO_INTERNO.getCodigo(), "Ocorreu um erro interno na aplicação."))
                ));
    }
}
