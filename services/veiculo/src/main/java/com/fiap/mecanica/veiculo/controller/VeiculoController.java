package com.fiap.mecanica.veiculo.controller;
...
import com.fiap.mecanica.veiculo.service.VeiculoService;
...
import static com.fiap.mecanica.veiculo.controller.mapper.VeiculoMapper.toDto;
import static com.fiap.mecanica.veiculo.controller.mapper.VeiculoMapper.toEntity;
...
public class VeiculoController {
    ...
    public List<VeiculoDto> getList() {
        return service.buscarTodos().stream()
                .map(com.fiap.mecanica.veiculo.controller.mapper.VeiculoMapper::toDto)
                .toList();
    }
    ...
    public VeiculoDto getByPlaca(@Parameter(description = "Placa do veículo") @PathVariable String placa) {
        return toDto(service.buscarPorPlaca(placa));
    }
