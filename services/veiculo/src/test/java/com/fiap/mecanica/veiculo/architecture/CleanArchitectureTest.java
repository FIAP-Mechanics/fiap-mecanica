package com.fiap.mecanica.veiculo.architecture;
...
@AnalyzeClasses(packages = "com.fiap.mecanica.veiculo")
class CleanArchitectureTest {

    private static final String BASE_PACKAGE = "com.fiap.mecanica.veiculo";
