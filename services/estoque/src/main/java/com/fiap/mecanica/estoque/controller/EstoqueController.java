package com.fiap.mecanica.estoque.controller;

import com.fiap.mecanica.estoque.controller.mapper.EstoqueMapper;
import com.fiap.mecanica.estoque.controller.request.AtualizarEstoqueRequest;
import com.fiap.mecanica.estoque.controller.request.AtualizarInsumoRequest;
import com.fiap.mecanica.estoque.controller.request.CadastrarEstoqueRequest;
import com.fiap.mecanica.estoque.domain.Estoque;
import com.fiap.mecanica.estoque.dto.DeduzirEstoqueItemDto;
import com.fiap.mecanica.estoque.dto.EstoqueDto;
import com.fiap.mecanica.estoque.service.EstoqueService;
...
import static com.fiap.mecanica.estoque.controller.mapper.EstoqueMapper.toDto;
import static com.fiap.mecanica.estoque.controller.mapper.EstoqueMapper.toEntity;
...
public class EstoqueController {
    ...
    @PostMapping("/deduzir")
    public void deduzir(@Valid @RequestBody List<DeduzirEstoqueItemDto> itens) {
        service.deduzirEstoque(itens);
    }
}
