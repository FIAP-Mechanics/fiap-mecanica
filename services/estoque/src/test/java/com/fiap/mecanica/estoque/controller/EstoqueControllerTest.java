...
import com.fiap.mecanica.estoque.controller.request.CadastrarInsumoRequest;
...
class EstoqueControllerTest {
    ...
    void deveDeduzirEstoqueComSucesso() {
        List<DeduzirEstoqueItemDto> itens = List.of(new DeduzirEstoqueItemDto(1L, 5L));

        controller.deduzir(itens);

        verify(service).deduzirEstoque(itens);
    }
