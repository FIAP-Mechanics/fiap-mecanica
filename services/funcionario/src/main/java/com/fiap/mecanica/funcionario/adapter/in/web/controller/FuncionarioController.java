...
import com.fiap.mecanica.funcionario.adapter.in.web.presenter.FuncionarioPresenter;
...
import static com.fiap.mecanica.funcionario.adapter.in.web.presenter.FuncionarioPresenter.toDto;
import static com.fiap.mecanica.funcionario.adapter.in.web.presenter.FuncionarioPresenter.toEntity;
...
public class FuncionarioController {
    ...
    public List<FuncionarioDto> getList() {
        return funcionarioUseCase.buscarTodos().stream()
                .map(FuncionarioPresenter::toDto)
                .toList();
    }
    ...
    public FuncionarioDto get(@Parameter(description = "ID do funcionário") @PathVariable Long id) {
        return toDto(funcionarioUseCase.buscarFuncionarioPorId(id));
    }
    ...
    public FuncionarioDto getByEmail(@Parameter(description = "E-mail do funcionário") @PathVariable String email) {
        return toDto(funcionarioUseCase.buscarPorEmail(email));
    }
    ...
    public FuncionarioDto create(@Valid @RequestBody CadastrarFuncionarioRequest request) {
        ...
        return toDto(funcionarioUseCase.cadastrarFuncionario(funcionario));
    }
    ...
    public FuncionarioDto update(
        ...
        AtualizarFuncionarioCommand command = FuncionarioPresenter.toCommand(request);
        return toDto(funcionarioUseCase.atualizarFuncionario(id, command));
    }
    ...
    public FuncionarioDto delete(@Parameter(description = "ID do funcionário") @PathVariable Long id) {
        return toDto(funcionarioUseCase.excluirFuncionario(id));
    }
    ...
    public FuncionarioDto reativar(@Parameter(description = "ID do funcionário") @PathVariable Long id) {
        return toDto(funcionarioUseCase.reativarFuncionario(id));
    }
}
