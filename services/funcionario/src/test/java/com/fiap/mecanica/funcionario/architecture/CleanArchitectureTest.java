package com.fiap.mecanica.funcionario.architecture;
...
@AnalyzeClasses(packages = "com.fiap.mecanica.funcionario")
class CleanArchitectureTest {

    private static final String BASE_PACKAGE = "com.fiap.mecanica.funcionario";
