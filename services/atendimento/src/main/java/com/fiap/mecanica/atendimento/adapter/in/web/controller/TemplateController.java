...
import com.fiap.mecanica.atendimento.adapter.in.web.presenter.TemplatePresenter;
...
public class TemplateController {
    ...
    public List<TemplateDto> getList() {
        return templateUseCase.buscarTodos().stream()
                .map(TemplatePresenter::toDto)
                .toList();
    }
    ...
    public TemplateDto get(
        ...
        return TemplatePresenter.toDto(templateUseCase.buscarPorCodigo(codigo));
    }
    ...
    public TemplateDto create(@Valid @RequestBody CriarTemplateRequest request) {
        return TemplatePresenter.toDto(templateUseCase.cadastrar(TemplatePresenter.toEntity(request)));
    }
    ...
    public TemplateDto update(
        ...
        AtualizarTemplateCommand command = new AtualizarTemplateCommand(request.conteudo());
        return TemplatePresenter.toDto(templateUseCase.atualizar(codigo, command));
    }
    ...
    public void delete(
        ...
        templateUseCase.deletar(codigo);
    }
}
